...
appname=""                                                                              # The name of our App deployment script (also used for Octory monitor)
app=""                                                                              # The actual name of our App once installed
logandmetadir=""                           # The location of our logs and last updated data
processpath=""                                    # The process name of the App we are installing
terminateprocess=""                                                                    # Do we want to terminate the running process? If false we'll wait until its not running
autoUpdate=""                                                                          # Application updates itself, if already installed we should exit
